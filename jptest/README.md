...
> 本项目是从 GitHub 仓库 jianpu_record 克隆并整理的海洋气象 Python 教程集合。

## 本地目录结构

```
jptest/
├── 01_wave_theory/          # 波动理论 - Kelvin波、Matsuno、赤道波动
├── 02_data_processing/      # 数据处理 - 滤波、EOF、PCA、数据同化
├── 03_plotting/             # 气象绘图 - 热力图、箱型图、风场图
├── 04_sst_analysis/         # 海温分析 - SST、趋势分析、海温锋面
├── 05_remote_sensing/       # 遥感数据 - 卫星、降水
├── 06_statistics/           # 气象统计 - 功率谱、自相关、稳定性
├── 07_tools/                # 工具类 - 坐标转换、爬虫、数据读取
├── 08_xarray/              # Xarray入门 - 海洋气象Xarray教程
├── data/                    # 数据文件夹
│   ├── Himawari-8/         # Himawari-8 卫星数据
│   ├── equatorial_wave_filter/  # 赤道波动滤波数据
│   └── test_data/          # 测试数据
└── README.md               # 本说明文件
```
...
pip install numpy matplotlib xarray pandas netCDF4 scipy cartopy seaborn jupyter
```
